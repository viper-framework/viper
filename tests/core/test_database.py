...
from viper.core.database import Analysis, Database, Malware, Note, Tag
...
class TestMalware:
    def test_init(self):
        ...
        assert (
            instance.__repr__()
            == "<Malware ('None','ad7b9c14083b52bc532fba5948342b98')>"
        )
...
class TestDatabase:
    ...
    @pytest.mark.parametrize(
        "filename, name", [("string_handling/dümmy.txt", "dümmy.txt")]
    )
