...
class TestLIEF:
    ...
    def test_args_exception(self):
        ...
        excinfo.match(
            r".*extract information from ELF, PE, MachO, DEX, OAT, ART and VDEX.*"
        )
    ...
    def test_methods_oat_existent_class(self, capsys, filename, expected):
        __sessions__.new(os.path.join(FIXTURE_DIR, filename))
        instance = lief()
        instance.set_commandline(
            ["oat", "--methods", "--classname", "com.qualcomm.qcrilhook.QmiOemHook"]
        )
        instance.run()
        out, err = capsys.readouterr()
        assert re.search(expected, out)
    ...
    def test_methods_dex_existent_class(self, capsys, filename, expected):
        ...
        instance = lief()
        instance.set_commandline(
            ["dex", "--methods", "--classname", "java.lang.Runtime"]
        )
        instance.run()
        out, err = capsys.readouterr()
        assert re.search(expected, out)
    ...
    def test_methods_oat_existent_class_name(self, capsys, filename, expected):
        ...
        instance.set_commandline(
            [
                ...
                "--methods",
                "--classname",
                "com.qualcomm.qcrilhook.QmiOemHook",
                "--name",
                "sendQmiMessageSync",
            ]
        )
    ...
    def test_methods_dex_existent_class_name(self, capsys, filename, expected):
        ...
        instance = lief()
        instance.set_commandline(
            ["dex", "--methods", "--classname", "java.lang.Runtime", "--name", "exec"]
        )
        instance.run()
        out, err = capsys.readouterr()
        assert re.search(expected, out)
    ...
    def test_extractdexfiles_oat_inexistent_name(self, capsys, filename, expected):
        ...
        instance = lief()
        instance.set_commandline(
            ["oat", "--extractdexfiles", "/tmp/", "--name", "inexistentdexfile"]
        )
        instance.run()
        out, err = capsys.readouterr()
        assert re.search(expected, out)
    ...
    def test_extractdexfiles_oat__name_ok(self, capsys, filename, expected):
        ...
        instance = lief()
        instance.set_commandline(
            ["oat", "--extractdexfiles", "/tmp/", "--name", "classes.dex"]
        )
        instance.run()
        out, err = capsys.readouterr()
        assert re.search(expected, out)
