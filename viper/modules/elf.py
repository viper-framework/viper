...
class ELF(Module):
    ...
    def __init__(self):
        ...
        parser_size = subparsers.add_parser('entropy', help='Show the ELF entropy')
        parser_size.add_argument('-a', '--all', action='store_true', help='Print the entropy of all files in the project')
        parser_size.add_argument('-c', '--cluster', action='store_true', help='Calculate and cluster all files in the project')
        parser_size.add_argument('-s', '--scan', action='store_true', help='Scan repository for matching samples')
