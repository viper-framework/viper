...
class Children(Command):
    ...
    def __init__(self):
        ...
        group.add_argument('-a', '--add', metavar='SHA256', help="Add child file by sha256")
        group.add_argument('-d', '--delete', metavar='SHA256', help="Delete Child")
        group.add_argument('-l', '--list', action='store_true', help="List all Children")
    ...
    def run(self, *args):
        ...
        if args.list:
            ...
            if child_ids:
                ...
                self.log('info', "No children found.")
